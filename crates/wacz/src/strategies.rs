...
/// Free-text tokens, including characters that require JSON escaping.
...
/// A path with an optional WACZ directory or root prefix, one or two segments, and an extension.
...
/// Text without line breaks, including values long enough to need an excerpt.
...
/// An instant from 1970 through 2099, with nanosecond precision.
...
/// A time zone offset in 15-minute increments, from UTC−12 to UTC+14.
