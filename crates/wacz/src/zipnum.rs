...
//!
//! The index reader and writer share these types, so the two sides of the format cannot drift.
//! Summary lines use compact JSON formatting, which is safe because readers parse the object
//! rather than its spacing.
