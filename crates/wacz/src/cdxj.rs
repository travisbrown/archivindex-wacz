...
//!
//! The data model comes from [`archivindex_cdx::format::cdxj`]. The stream reader lives here
//! because line-oriented I/O and source diagnostics are WACZ concerns; its errors carry source
//! locations.

use std::io::BufRead;

use archivindex_cdx::format::cdxj::{Error as ParseError, Item};
